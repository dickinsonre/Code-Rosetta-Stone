...
- Eight top-level tabs: "Rosetta Stone" (code comparison), "PySWMM4" (embedded SWMM4PyExplorer via iframe from https://swmm-explorer-1-robertdickinson.replit.app), "MicroGPT" (embedded SWMM5 MicroGPT via iframe from https://micro-gpt-swmm.replit.app), "SWMM GUI" (embedded SWMM GUI Explorer via iframe from https://swmm-explorer-1.replit.app), "SWMM-CAT" (embedded SWMM-CAT Climate Assessment Tool via iframe from https://swmm-explorer-2.replit.app), "swmmr" (embedded swmmr R package explorer via iframe from https://swmmr-explorer.replit.app), "SWMManywhere" (embedded SWMManywhere urban drainage synthesizer via iframe from https://swm-explorer.replit.app), and "PySWMM5" (embedded PySWMM Explorer via iframe from https://swmm-explorer-2.replit.app)
