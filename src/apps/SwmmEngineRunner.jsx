    ...
    try {
      if (selectedEngine === 'js-swmm5') {
        ...
        const engineApiMap = {
          ...
          'kotlin-swmm5': '/api/run-swmm-kotlin',
          'scala-swmm5': '/api/run-swmm-scala',
          'nim-swmm5': '/api/run-swmm-nim',
          'zig-swmm5': '/api/run-swmm-zig',
          'dart-swmm5': '/api/run-swmm-dart',
          'tcl-swmm5': '/api/run-swmm-tcl',
          'scheme-swmm5': '/api/run-swmm-racket',
          'elixir-swmm5': '/api/run-swmm-elixir',
          'fortran-swmm5': '/api/run-swmm-fortran',
          'r-swmm5': '/api/run-swmm-r',
          'ocaml-swmm5': '/api/run-swmm-ocaml',
          'haskell-swmm5': '/api/run-swmm-haskell',
          'delphi-swmm5': '/api/run-swmm-pascal',
          'commonlisp-swmm5': '/api/run-swmm-lisp',
          'ada-swmm5': '/api/run-swmm-ada',
        };
        const engineLabel = {
